...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Timer Billing Gambut</h1>
        <div>
    ...
    <div id="section-gambut" class="fade-in">
...
function sortCardsByNumber() {
    const container = $('#container-gambut');
...
function renderCard(id) {
    ...
    $(`#container-gambut`).append(cardHtml);
}
...
function renderHistory() {
    ...
    historyData.forEach(item => {
        if (item.cabang !== 'gambut') return;
        $('#historyContainer').append(`
            <li class="list-group-item d-flex justify-content-between align-items-center px-3 py-2">
                <span class="font-weight-bold" style="font-size: 13px;">
                    <span class="badge badge-success mr-2">Gambut</span> 
...
function handleTimerFinish(id) {
    ...
    Swal.fire({
        title: "Waktu Habis!",
        text: `Waktu untuk ${t.noMeja} (${t.judulMeja}) di Cabang Gambut telah selesai.`,
        icon: "warning",
