...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 text-center">
            <h6 class="m-0 font-weight-bold" style="font-size:25px;">PDAM</h6>
            <div class="mt-3">
        ...
        <form id="formPengeluaran" action="" method="POST" autocomplete="off">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="level" id="level" value="pdam">
    ...
    $('#btnHapus').click(function() {
        if(selectedId) {
            if(confirm('Hapus data pengeluaran ' + selectedData.nama_staff_ruko + '?')) {
                window.location.href = 'pdam?hapus_id=' + selectedId;
            }
        }
    });
