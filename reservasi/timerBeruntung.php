...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Timer Billing Beruntung</h1>
        <div>
    ...
    <div id="section-beruntung" class="fade-in">
...
function sortCardsByNumber() {
    const container = $('#container-beruntung');
...
function renderCard(id) {
    ...
    $(`#container-beruntung`).append(cardHtml);
}
...
function renderHistory() {
    ...
    historyData.forEach(item => {
        if (item.cabang !== 'beruntung') return;
        $('#historyContainer').append(`
            <li class="list-group-item d-flex justify-content-between align-items-center px-3 py-2">
                <span class="font-weight-bold" style="font-size: 13px;">
                    <span class="badge badge-primary mr-2">Beruntung</span> 
...
function syncData() {
    ...
    $.post(API_URL, { action: 'load' }, function(data) {
        ...
        for (const id in dbTimers) {
            ...
            if (dbT.cabang !== 'beruntung') continue;
            ...
            if (!timers[id]) {
                ...
                if (!timers[id].isRunning || !isRunning) {
...
function handleTimerFinish(id) {
    ...
    Swal.fire({
        title: "Waktu Habis!",
        text: `Waktu untuk ${t.noMeja} (${t.judulMeja}) di Cabang Beruntung telah selesai.`,
        icon: "warning",
