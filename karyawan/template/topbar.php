    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php
                // CEK LOKASI FILE GAMBAR:
                // Jika data gambar di database hanya nama file (misal: "foto_budi.jpg"),
                // dan folder tempat simpan gambar ada di "img/" (di root aplikasi),
                // maka kita perlu menambahkan "../img/" agar bisa dipanggil dari dalam folder admin/reservasi
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?= asset('karyawan/logout.php'); ?>">
